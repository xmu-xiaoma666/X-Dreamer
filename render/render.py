...
def shade(
    ...
    gb_normal1 = gb_normal @ normal_rotate[:,None,...]
    # We randomly rotate the normals to change the color gamut of nomral at the same angle. We find this help to deform the shape
